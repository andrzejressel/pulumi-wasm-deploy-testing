...
impl container::Guest for Component {
    fn invoke(name: String, args: container::Args) -> container::Res {
        ...
        let request = RegisterResourceRequest {
            ...
            results: vec![
                ResultField { name: "attach".into() },
                ResultField { name: "bridge".into() },
                ResultField { name: "capabilities".into() },
                ResultField { name: "cgroupnsMode".into() },
                ResultField { name: "command".into() },
                ResultField { name: "containerLogs".into() },
                ResultField { name: "containerReadRefreshTimeoutMilliseconds".into() },
                ResultField { name: "cpuSet".into() },
                ResultField { name: "cpuShares".into() },
                ResultField { name: "destroyGraceSeconds".into() },
                ResultField { name: "devices".into() },
                ResultField { name: "dns".into() },
                ResultField { name: "dnsOpts".into() },
                ResultField { name: "dnsSearches".into() },
                ResultField { name: "domainname".into() },
                ResultField { name: "entrypoints".into() },
                ResultField { name: "envs".into() },
                ResultField { name: "exitCode".into() },
                ResultField { name: "gpus".into() },
                ResultField { name: "groupAdds".into() },
                ResultField { name: "healthcheck".into() },
                ResultField { name: "hostname".into() },
                ResultField { name: "hosts".into() },
                ResultField { name: "image".into() },
                ResultField { name: "init".into() },
                ResultField { name: "ipcMode".into() },
                ResultField { name: "labels".into() },
                ResultField { name: "logDriver".into() },
                ResultField { name: "logOpts".into() },
                ResultField { name: "logs".into() },
                ResultField { name: "maxRetryCount".into() },
                ResultField { name: "memory".into() },
                ResultField { name: "memorySwap".into() },
                ResultField { name: "mounts".into() },
                ResultField { name: "mustRun".into() },
                ResultField { name: "name".into() },
                ResultField { name: "networkDatas".into() },
                ResultField { name: "networkMode".into() },
                ResultField { name: "networksAdvanced".into() },
                ResultField { name: "pidMode".into() },
                ResultField { name: "ports".into() },
                ResultField { name: "privileged".into() },
                ResultField { name: "publishAllPorts".into() },
                ResultField { name: "readOnly".into() },
                ResultField { name: "removeVolumes".into() },
                ResultField { name: "restart".into() },
                ResultField { name: "rm".into() },
                ResultField { name: "runtime".into() },
                ResultField { name: "securityOpts".into() },
                ResultField { name: "shmSize".into() },
                ResultField { name: "start".into() },
                ResultField { name: "stdinOpen".into() },
                ResultField { name: "stopSignal".into() },
                ResultField { name: "stopTimeout".into() },
                ResultField { name: "storageOpts".into() },
                ResultField { name: "sysctls".into() },
                ResultField { name: "tmpfs".into() },
                ResultField { name: "tty".into() },
                ResultField { name: "ulimits".into() },
                ResultField { name: "uploads".into() },
                ResultField { name: "user".into() },
                ResultField { name: "usernsMode".into() },
                ResultField { name: "volumes".into() },
                ResultField { name: "wait".into() },
                ResultField { name: "waitTimeout".into() },
                ResultField { name: "workingDir".into() },
            ],
        };
