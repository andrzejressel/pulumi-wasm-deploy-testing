...
pub mod container {
    ...
    pub fn container(name: &str, args: ContainerArgs) -> ContainerResult {
        ...
        let result = crate::bindings::pulumi::docker::container::invoke(name, &crate::bindings::pulumi::docker::container::Args {
            ...
            capabilities: &crate::clone::<Option<crate::types::ContainerCapabilities>>(args.capabilities),
            cgroupns_mode: &crate::clone::<Option<String>>(args.cgroupns_mode),
            command: &crate::clone::<Option<Vec<String>>>(args.command),
            container_read_refresh_timeout_milliseconds: &crate::clone::<Option<i32>>(args.container_read_refresh_timeout_milliseconds),
            ...
            healthcheck: &crate::clone::<Option<crate::types::ContainerHealthcheck>>(args.healthcheck),
            ...
            log_opts: &crate::clone::<Option<std::collections::HashMap<String, String>>>(args.log_opts),
            ...
            networks_advanced: &crate::clone::<Option<Vec<crate::types::ContainerNetworksAdvanced>>>(args.networks_advanced),
            ...
            storage_opts: &crate::clone::<Option<std::collections::HashMap<String, String>>>(args.storage_opts),
            sysctls: &crate::clone::<Option<std::collections::HashMap<String, String>>>(args.sysctls),
            tmpfs: &crate::clone::<Option<std::collections::HashMap<String, String>>>(args.tmpfs),
        ...
        ContainerResult {
            ...
            capabilities: crate::random_to_domain_mapper::<Option<crate::types::ContainerCapabilities>>(result.capabilities),
            ...
            container_read_refresh_timeout_milliseconds: crate::random_to_domain_mapper::<Option<i32>>(result.container_read_refresh_timeout_milliseconds),
            ...
            destroy_grace_seconds: crate::random_to_domain_mapper::<Option<i32>>(result.destroy_grace_seconds),
            devices: crate::random_to_domain_mapper::<Option<Vec<crate::types::ContainerDevice>>>(result.devices),
            ...
            dns_searches: crate::random_to_domain_mapper::<Option<Vec<String>>>(result.dns_searches),
            ...
            healthcheck: crate::random_to_domain_mapper::<Option<crate::types::ContainerHealthcheck>>(result.healthcheck),
            hostname: crate::random_to_domain_mapper::<String>(result.hostname),
            hosts: crate::random_to_domain_mapper::<Option<Vec<crate::types::ContainerHost>>>(result.hosts),
            ...
            labels: crate::random_to_domain_mapper::<Vec<crate::types::ContainerLabel>>(result.labels),
            log_driver: crate::random_to_domain_mapper::<String>(result.log_driver),
            log_opts: crate::random_to_domain_mapper::<Option<std::collections::HashMap<String, String>>>(result.log_opts),
            ...
            mounts: crate::random_to_domain_mapper::<Option<Vec<crate::types::ContainerMount>>>(result.mounts),
            must_run: crate::random_to_domain_mapper::<Option<bool>>(result.must_run),
            name: crate::random_to_domain_mapper::<String>(result.name),
            network_datas: crate::random_to_domain_mapper::<Vec<crate::types::ContainerNetworkData>>(result.network_datas),
            network_mode: crate::random_to_domain_mapper::<Option<String>>(result.network_mode),
            networks_advanced: crate::random_to_domain_mapper::<Option<Vec<crate::types::ContainerNetworksAdvanced>>>(result.networks_advanced),
            pid_mode: crate::random_to_domain_mapper::<Option<String>>(result.pid_mode),
            ports: crate::random_to_domain_mapper::<Option<Vec<crate::types::ContainerPort>>>(result.ports),
            privileged: crate::random_to_domain_mapper::<Option<bool>>(result.privileged),
            publish_all_ports: crate::random_to_domain_mapper::<Option<bool>>(result.publish_all_ports),
            ...
            storage_opts: crate::random_to_domain_mapper::<Option<std::collections::HashMap<String, String>>>(result.storage_opts),
            sysctls: crate::random_to_domain_mapper::<Option<std::collections::HashMap<String, String>>>(result.sysctls),
            tmpfs: crate::random_to_domain_mapper::<Option<std::collections::HashMap<String, String>>>(result.tmpfs),
            tty: crate::random_to_domain_mapper::<Option<bool>>(result.tty),
            ulimits: crate::random_to_domain_mapper::<Option<Vec<crate::types::ContainerUlimit>>>(result.ulimits),
            uploads: crate::random_to_domain_mapper::<Option<Vec<crate::types::ContainerUpload>>>(result.uploads),
            ...
            volumes: crate::random_to_domain_mapper::<Option<Vec<crate::types::ContainerVolume>>>(result.volumes),
...
pub mod network {
    ...
    pub fn network(name: &str, args: NetworkArgs) -> NetworkResult {
        ...
        let result = crate::bindings::pulumi::docker::network::invoke(name, &crate::bindings::pulumi::docker::network::Args {
            ...
            ipam_configs: &crate::clone::<Option<Vec<crate::types::NetworkIpamConfig>>>(args.ipam_configs),
            ipam_driver: &crate::clone::<Option<String>>(args.ipam_driver),
            ipam_options: &crate::clone::<Option<std::collections::HashMap<String, String>>>(args.ipam_options),
            ipv6: &crate::clone::<Option<bool>>(args.ipv6),
            labels: &crate::clone::<Option<Vec<crate::types::NetworkLabel>>>(args.labels),
            name: &crate::clone::<Option<String>>(args.name),
            options: &crate::clone::<Option<std::collections::HashMap<String, String>>>(args.options),
        });
        ...
        NetworkResult {
            ...
            ipam_configs: crate::random_to_domain_mapper::<Vec<crate::types::NetworkIpamConfig>>(result.ipam_configs),
            ipam_driver: crate::random_to_domain_mapper::<Option<String>>(result.ipam_driver),
            ipam_options: crate::random_to_domain_mapper::<Option<std::collections::HashMap<String, String>>>(result.ipam_options),
            ipv6: crate::random_to_domain_mapper::<Option<bool>>(result.ipv6),
            labels: crate::random_to_domain_mapper::<Option<Vec<crate::types::NetworkLabel>>>(result.labels),
            name: crate::random_to_domain_mapper::<String>(result.name),
            options: crate::random_to_domain_mapper::<std::collections::HashMap<String, String>>(result.options),
...
pub mod plugin {
    ...
    pub fn plugin(name: &str, args: PluginArgs) -> PluginResult {
        ...
        let result = crate::bindings::pulumi::docker::plugin::invoke(name, &crate::bindings::pulumi::docker::plugin::Args {
            ...
            grant_permissions: &crate::clone::<Option<Vec<crate::types::PluginGrantPermission>>>(args.grant_permissions),
            name: &crate::clone::<Option<String>>(args.name),
        });
        ...
        PluginResult {
            ...
            grant_all_permissions: crate::random_to_domain_mapper::<Option<bool>>(result.grant_all_permissions),
            grant_permissions: crate::random_to_domain_mapper::<Option<Vec<crate::types::PluginGrantPermission>>>(result.grant_permissions),
            name: crate::random_to_domain_mapper::<String>(result.name),
...
pub mod registry_image {
    ...
    pub fn registry_image(name: &str, args: RegistryImageArgs) -> RegistryImageResult {
        ...
        let result = crate::bindings::pulumi::docker::registry_image::invoke(name, &crate::bindings::pulumi::docker::registry_image::Args {
            ...
            name: &crate::clone::<Option<String>>(args.name),
            triggers: &crate::clone::<Option<std::collections::HashMap<String, String>>>(args.triggers),
        });

        RegistryImageResult {
            insecure_skip_verify: crate::random_to_domain_mapper::<Option<bool>>(result.insecure_skip_verify),
            ...
            triggers: crate::random_to_domain_mapper::<Option<std::collections::HashMap<String, String>>>(result.triggers),
        }
    }
...
pub mod remote_image {
    ...
    pub fn remote_image(name: &str, args: RemoteImageArgs) -> RemoteImageResult {
        ...
        RemoteImageResult {
            build: crate::random_to_domain_mapper::<Option<crate::types::RemoteImageBuild>>(result.build),
            ...
            name: crate::random_to_domain_mapper::<String>(result.name),
            platform: crate::random_to_domain_mapper::<Option<String>>(result.platform),
            pull_triggers: crate::random_to_domain_mapper::<Option<Vec<String>>>(result.pull_triggers),
            repo_digest: crate::random_to_domain_mapper::<String>(result.repo_digest),
            triggers: crate::random_to_domain_mapper::<Option<std::collections::HashMap<String, String>>>(result.triggers),
        }
    }
...
pub mod secret {
    ...
    pub fn secret(name: &str, args: SecretArgs) -> SecretResult {
        ...
        SecretResult {
            ...
            labels: crate::random_to_domain_mapper::<Option<Vec<crate::types::SecretLabel>>>(result.labels),
            name: crate::random_to_domain_mapper::<String>(result.name),
        }
    }
...
pub mod service {
    ...
    pub fn service(name: &str, args: ServiceArgs) -> ServiceResult {
        ...
        let result = crate::bindings::pulumi::docker::service::invoke(name, &crate::bindings::pulumi::docker::service::Args {
            ...
            converge_config: &crate::clone::<Option<crate::types::ServiceConvergeConfig>>(args.converge_config),
            endpoint_spec: &crate::clone::<Option<crate::types::ServiceEndpointSpec>>(args.endpoint_spec),
            ...
            name: &crate::clone::<Option<String>>(args.name),
            rollback_config: &crate::clone::<Option<crate::types::ServiceRollbackConfig>>(args.rollback_config),
            task_spec: &crate::clone::<crate::types::ServiceTaskSpec>(args.task_spec),
            update_config: &crate::clone::<Option<crate::types::ServiceUpdateConfig>>(args.update_config),
        });

        ServiceResult {
            auth: crate::random_to_domain_mapper::<Option<crate::types::ServiceAuth>>(result.auth),
            converge_config: crate::random_to_domain_mapper::<Option<crate::types::ServiceConvergeConfig>>(result.converge_config),
            endpoint_spec: crate::random_to_domain_mapper::<crate::types::ServiceEndpointSpec>(result.endpoint_spec),
            labels: crate::random_to_domain_mapper::<Vec<crate::types::ServiceLabel>>(result.labels),
            mode: crate::random_to_domain_mapper::<crate::types::ServiceMode>(result.mode),
            name: crate::random_to_domain_mapper::<String>(result.name),
            rollback_config: crate::random_to_domain_mapper::<Option<crate::types::ServiceRollbackConfig>>(result.rollback_config),
            task_spec: crate::random_to_domain_mapper::<crate::types::ServiceTaskSpec>(result.task_spec),
            update_config: crate::random_to_domain_mapper::<Option<crate::types::ServiceUpdateConfig>>(result.update_config),
        }
    }
...
pub mod volume {
    ...
    pub fn volume(name: &str, args: VolumeArgs) -> VolumeResult {
        ...
        let result = crate::bindings::pulumi::docker::volume::invoke(name, &crate::bindings::pulumi::docker::volume::Args {
            driver: &crate::clone::<Option<String>>(args.driver),
            driver_opts: &crate::clone::<Option<std::collections::HashMap<String, String>>>(args.driver_opts),
        ...
        VolumeResult {
            driver: crate::random_to_domain_mapper::<String>(result.driver),
            driver_opts: crate::random_to_domain_mapper::<Option<std::collections::HashMap<String, String>>>(result.driver_opts),
            labels: crate::random_to_domain_mapper::<Option<Vec<crate::types::VolumeLabel>>>(result.labels),
