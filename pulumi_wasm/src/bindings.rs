...
pub mod exports {
    ...
    pub mod component {
        ...
        pub mod pulumi_wasm {
            ...
            pub mod output_interface {
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_method_output_get_cabi<T: GuestOutput>(
                    arg0: *mut u8,
                ) -> *mut u8 {
                    #[cfg(target_arch = "wasm32")]
                    _rt::run_ctors_once();
                ...
                pub trait GuestOutput: 'static {
                    ...
                    fn get_field(&self, field: _rt::String, required: bool) -> Output;
  ...
  ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {
    ...
    unsafe extern "C" fn export_method_output_get(arg0: *mut u8,) -> *mut u8 {
    ...
    unsafe extern "C" fn export_method_output_get_field(arg0: *mut u8,arg1: *mut u8,arg2: usize,arg3: i32,) -> i32 {
      $($path_to_types)*::_export_method_output_get_field_cabi::<<$ty as $($path_to_types)*::Guest>::Output>(arg0, arg1, arg2, arg3)
    }
    #[export_name = "component:pulumi-wasm/output-interface@0.1.0#[method]output.get-type"]
    unsafe extern "C" fn export_method_output_get_type(arg0: *mut u8,) -> *mut u8 {
...
\x07\x01@\x03\x04self\x04\x05fields\x08required\x7f\0\x02\x04\0\x18[method]outpu\
t.get-field\x01\x08\x01@\x01\x04self\x04\0s\x04\0\x17[method]output.get-type\x01\
