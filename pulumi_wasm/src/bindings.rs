    ...
    pub mod pulumi_wasm {
        ...
        pub mod log {
            ...
            pub fn log(content: &Content) {
                unsafe {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "component:pulumi-wasm/log@0.0.0")]
                    extern "C" {
                        #[link_name = "log"]
                        fn wit_import(
                            _: i32,
        ...
        pub mod external_world {
            ...
            pub fn is_in_preview() -> bool {
                unsafe {
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "component:pulumi-wasm/external-world@0.0.0")]
                    extern "C" {
...
pub mod exports {
            ...
            pub mod output_interface {
                ...
                unsafe impl _rt::WasmResource for Output {
                    ...
                    unsafe fn drop(_handle: u32) {
                        ...
                        {
                            #[link(
                                wasm_import_module = "[export]component:pulumi-wasm/output-interface@0.0.0"
                            )]
                            extern "C" {
                ...
                macro_rules! __export_component_pulumi_wasm_output_interface_0_0_0_cabi{
  ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {

    #[export_name = "component:pulumi-wasm/output-interface@0.0.0#[constructor]output"]
    ...
    #[export_name = "component:pulumi-wasm/output-interface@0.0.0#[method]output.map"]
    ...
    #[export_name = "component:pulumi-wasm/output-interface@0.0.0#combine"]
    ...
    const _: () = {
      #[doc(hidden)]
      #[export_name = "component:pulumi-wasm/output-interface@0.0.0#[dtor]output"]
      #[allow(non_snake_case)]
      unsafe extern "C" fn dtor(rep: *mut u8) {
        ...
        >(rep)
                ...
                #[doc(hidden)]
                pub(crate) use __export_component_pulumi_wasm_output_interface_0_0_0_cabi;
            }
  ...
  ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {
    ...
    #[export_name = "component:pulumi-wasm/register-interface@0.0.0#register"]
    ...
    #[export_name = "cabi_post_component:pulumi-wasm/register-interface@0.0.0#register"]
    unsafe extern "C" fn _post_return_register(arg0: *mut u8,) {
      $($path_to_types)*::__post_return_register::<$ty>(arg0)
                ...
                #[doc(hidden)]
                pub(crate) use __export_component_pulumi_wasm_register_interface_0_0_0_cabi;
                #[repr(align(4))]
            ...
            pub mod stack_interface {
                ...
                macro_rules! __export_component_pulumi_wasm_stack_interface_0_0_0_cabi{
  ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {

    #[export_name = "component:pulumi-wasm/stack-interface@0.0.0#add-export"]
    ...
    #[export_name = "component:pulumi-wasm/stack-interface@0.0.0#finish"]
    unsafe extern "C" fn export_finish(arg0: *mut u8,arg1: usize,) -> *mut u8 {
      $($path_to_types)*::_export_finish_cabi::<$ty>(arg0, arg1)
    }
    #[export_name = "cabi_post_component:pulumi-wasm/stack-interface@0.0.0#finish"]
    unsafe extern "C" fn _post_return_finish(arg0: *mut u8,) {
      $($path_to_types)*::__post_return_finish::<$ty>(arg0)
                ...
                #[doc(hidden)]
                pub(crate) use __export_component_pulumi_wasm_stack_interface_0_0_0_cabi;
                #[repr(align(4))]
                struct _RetArea([::core::mem::MaybeUninit<u8>; 8]);
                static mut _RET_AREA: _RetArea = _RetArea([::core::mem::MaybeUninit::uninit(); 8]);
            }
...
macro_rules! __export_pulumi_wasm_impl {
  ...
  $($path_to_types_root)*::exports::component::pulumi_wasm::output_interface::__export_component_pulumi_wasm_output_interface_0_0_0_cabi!($ty with_types_in $($path_to_types_root)*::exports::component::pulumi_wasm::output_interface);
  $($path_to_types_root)*::exports::component::pulumi_wasm::register_interface::__export_component_pulumi_wasm_register_interface_0_0_0_cabi!($ty with_types_in $($path_to_types_root)*::exports::component::pulumi_wasm::register_interface);
  $($path_to_types_root)*::exports::component::pulumi_wasm::stack_interface::__export_component_pulumi_wasm_stack_interface_0_0_0_cabi!($ty with_types_in $($path_to_types_root)*::exports::component::pulumi_wasm::stack_interface);
  )
}
#[doc(inline)]
...
ent:pulumi-wasm/log@0.0.0\x05\0\x01B\x10\x01p}\x01r\x02\x09output-ids\x04body\0\x04\
...
\x0a\x03\x01*component:pulumi-wasm/external-world@0.0.0\x05\x01\x01B\x0c\x04\0\x06\
...
ulumi-wasm/output-interface@0.0.0\x05\x02\x02\x03\0\x02\x06output\x01B\x13\x02\x03\
...
register\x01\x11\x04\x01.component:pulumi-wasm/register-interface@0.0.0\x05\x04\x01\
...
ack-interface@0.0.0\x05\x05\x04\x01'component:pulumi-wasm/pulumi-wasm@0.0.0\x04\0\
