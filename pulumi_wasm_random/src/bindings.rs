  ...
  pub mod pulumi_wasm {
    ...
    pub mod register_interface {
      ...
      pub fn register(request: RegisterResourceRequest<'_,>,){
        ...
        use wit_bindgen::rt::{alloc, vec::Vec, string::String};
        unsafe {
          let RegisterResourceRequest{ type_:type_0, name:name0, object_names:object_names0, object:object0, } = request;
          let vec1 = type_0;
          let ptr1 = vec1.as_ptr() as i32;
          let len1 = vec1.len() as i32;
          let vec2 = name0;
          ...
          for (i, e) in vec6.into_iter().enumerate() {
            let base = result6 as i32 + (i as i32) * 4;
            {
              ...
              *((base + 0) as *mut i32) = (object5).handle() as i32;
            }
          }
          ...
          wit_import(ptr1, len1, ptr2, len2, result4 as i32, len4, result6 as i32, len6);
          if layout4.size() != 0 {
    ...
    pub mod pulumi_wasm {
      ...
      pub mod pulumi_provider_random_interface {
        ...
        const _: () = {
          ...
          unsafe extern "C" fn __export_create_random_string(arg0: i32,arg1: i32,arg2: i32,) {
            #[allow(unused_imports)]
            use wit_bindgen::rt::{alloc, vec::Vec, string::String};
